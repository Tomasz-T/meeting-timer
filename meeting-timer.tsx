  ...
  return (
    <div className="flex flex-col items-center p-6 max-w-md mx-auto bg-white rounded-lg overflow-hidden font-sans">
      ...
      <div className="w-full mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg space-y-4 flat">
        <div className="text-6xl text-center mb-4 tracking-wider font-bold text-gray-800" style={{ fontFamily: 'DM Sans, sans-serif' }}>
          {formatTime(elapsedTime)}
        </div>
        
        <div className="text-center text-lg text-blue-600 mb-2 font-bold" style={{ fontFamily: 'Inter, sans-serif' }}>
          Real time: <span style={{ fontFamily: 'DM Sans, sans-serif' }}>{calculateRealTime()}</span>
        </div>
      ...
      <div className="flex flex-col items-center justify-center gap-4 mb-6 w-full">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="flex items-center justify-center w-16 h-10 bg-white rounded-lg border border-gray-200">
            <span className="text-xl font-light text-gray-800" style={{ fontFamily: 'DM Sans, sans-serif' }}>{participants}</span>
          </div>
